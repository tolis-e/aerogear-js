...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            auth: {
                src: ['src/aerogear.core.js', 'src/external/es6-promise/promise-0.1.1.js', 'src/aerogear.ajax.js', 'src/authentication/aerogear.auth.js', 'src/authentication/adapters/rest.js'],
